            ...
            {quiz &&
                <div>
                    ...
                    <div className="row mt-4">
                        ...
                        <div className="col-9 mb-2">
                            <div className="form-group d-flex w-50 p-2 border rounded">
                                <input type="checkbox" id="wd-show-correct-answers" className="form-check-input me-2" defaultChecked={quiz.showCorrectAnswers} onChange={(e) => setQuiz({ ...quiz, showCorrectAnswers: e.target.checked ? (quiz.showCorrectAnswers ? quiz.showCorrectAnswers.substring(0, 16) : nowInEST()) : "" })} />
                                <label className="form-label me-4" htmlFor="wd-show-correct-answers">Show Correct Answers</label>
                                {quiz.showCorrectAnswers &&
                                    <input type="datetime-local" className="form-control me-2 w-50" id="wd-show-correct-answers-by" value={quiz.showCorrectAnswers.substring(0, 16) || nowInEST().substring(0, 16)} onChange={(e) => setQuiz({ ...quiz, showCorrectAnswers: String(e.target.value) + ":00.000Z" })} />
                                }
                            </div>
                        </div>
                        <div className="col-3"></div>
                        ...
                        <div className="col-5 mt-4 ms-2 mb-2 border rounded p-2">
                            <div className="row p-4">
                                ...
                                <input type="datetime-local" className="col-12 form-control mb-4" id="wd-due-date" value={quiz.dueDate.substring(0, 16)}
                                    onChange={(e) => setQuiz({ ...quiz, dueDate: String(e.target.value) + ":00.000Z" })} />
                                ...
                                <div className="col-12 d-inline-flex">
                                    <input type="datetime-local" className="form-control w-50 mb-4 me-2" id="wd-available-date" value={quiz.availableDate.substring(0, 16)}
                                        onChange={(e) => setQuiz({ ...quiz, availableDate: String(e.target.value) + ":00.000Z" })} />
                                    <input type="datetime-local" className="form-control w-50 mb-4" id="wd-until-date" value={quiz.untilDate.substring(0, 16)}
                                        onChange={(e) => {
                                            setQuiz({ ...quiz, untilDate: String(e.target.value) + ":00.000Z" })
                                        }} />
                                </div>
                            </div>
                        </div>
