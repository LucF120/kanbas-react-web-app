        ...
        <div id="wd-quiz-details-editor">
            {quiz &&
                <div>
                    ...
                    <span className="mt-2 mb-2">Quiz Instructions:</span>
                    <textarea className="form-control mt-2 mb-4" value={quiz.description} onChange={(e) => setQuiz({ ...quiz, description: e.target.value })} />
