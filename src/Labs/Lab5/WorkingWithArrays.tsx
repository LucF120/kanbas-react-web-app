...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <textarea value={todo.description} className="form-control w-25 float-start me-2" onChange={(e) => setTodo({ ...todo, description: e.target.value })} />
            <br /><br /><br />
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input type="checkbox" checked={todo.completed} className="w-25 float-start me-2" onChange={(e) => setTodo({ ...todo, completed: !todo.completed })} />
            <br /><br /> <hr />
        </div>
    );
}
