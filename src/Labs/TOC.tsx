...
export default function TOC() {
  ...
  return (
	...
	<li className="nav-item"><a id="wd-a5" href="#/Labs/Lab5" className={`nav-link ${pathname.includes("Lab5") ? "active" : ""}`}>Lab 5</a></li> */}
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/LucF120/kanbas-react-web-app/" className="nav-link">React.js Project GitHub</a></li>
      <li className="nav-item"><a id="wd-server-github" href="https://github.com/LucF120/kanbas-node-server-app" className="nav-link">Node.js Project Github</a></li>
      <li className="nav-item"><a id="wd-server" href="https://p-kanbas-node-server-app.onrender.com" className="nav-link">Server</a></li>
    </ul>
  );
}
